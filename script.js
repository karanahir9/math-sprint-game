...
function updateBestScore() {
  bestScoresArray.forEach((score, index) => {
    ...
    if(questionAmount == score.questions) {
      // Return Best score as number with decimal
      const savedbestScore = Number(bestScoresArray[index].bestScore);
      // Update is new final score is less or replacing zero
...
function scoresToDOM() {
  ...
  console.log("final time", finalTimeDisplay);
...
// Stop Timer, Process the results
function checkTime() {
  ...
  if(playerGuessArray.length == questionAmount) {
    ...
    console.log('time', timePlayed, 'penalty time', penaltyTime, 'final:', finalTime);
    scoresToDOM();
  }
}
...
// Form that decides no of questions
